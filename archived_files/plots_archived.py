...
radius_times[box_check[1]] = [3,3,max_v,max_v]
center_times[box_check[2]] = [7,7,0,0]
radius_times[box_check[2]] = [3,3,1,1]
...
axs40.tick_params(axis='both', labelsize=textsize)
#axs40.locator_params(axis='y', nbins=4)
axs40.grid()
